...
<div class="well-global">
    <% if (CommentCounter > 0) { %>
        ...
        <a id="commenttoggle" style="float: right; width: 20px; height: 20px; border: 1px solid #ccc; text-decoration: none; text-align: center" 
            href="javascript:toggle_visibility('commentlist', 'commenttoggle');">-</a>
        </h3>
    <%} else {%>
        <h3 class="well-global-title" id="H1">
            Comments (0)
        </h3>   
    <%} %>
